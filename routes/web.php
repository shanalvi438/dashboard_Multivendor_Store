...
Route::middleware(['admin'])->group(function () {
    ...
    // Vedor Status Update
    // Route::post('/vendors/{id}/activate', [VendorController::class, 'activateStatus'])->name('vendors.activate');
    ...
    // Route::patch('vendors/{id}/status',[VendorsController::class, 'edit'])->name('vendors.status');
    ...
    Route::get('account_setting/{id}/edit',[AccountSettingController::class,'edit'])->name('account-setting.edit');
    Route::Put('account-setting/{id}/update',[AccountSettingController::class,'update'])->name('account-setting.update');
});
//  =====
...
Route::middleware(['vendor'])->group(function () {
    ...
    Route::post('sellerCardSave/{id}', [VendorsController::class, 'sellerCardSave']);
    Route::get('sellerCardShow/{id}', [VendorsController::class, 'sellerCardShow'])->name('sellerCardShow/{id}');
    ...
    Route::get('service/{id}',[ServicesController::class, 'index'])->name('Service.view');
    Route::resource('services', ServicesController::class);
    Route::resource('portfolios', PortfolioController::class);
    Route::get('customerqueries', [ProductContactController::class, 'index'])->name('customerqueries');
    Route::get('/products/customerqueries', 'App\Http\Controllers\ProductContactController@index');
...
Route::middleware(['bothAccess'])->group(function () {
    ...
    Route::get('all/parcels', [OrderController::class, 'OrderDetailIndex'])->name('order_details');
    // ????
