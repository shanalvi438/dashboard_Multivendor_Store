...
Route::get('/sub_categories/{id}/{category_id}', [ApiController::class, 'subCategories_Product']); 

    
// Route::get('/sub_categories//{category_id}', [ApiController::class, 'subCategories_Product']);   
// Route::get('/sub_categories/{id}', [ApiController::class, 'subCategories_Product']);
...
Route::post('/customer/cancel-status', [ApiController::class,'CustomerCancelStatus']);
