                    ...
                    <div class="col-md-3">
                        <div class="dropdown" id="titleDropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                <input type="text" id="titleSearchInput" placeholder="Search..." oninput="filtertitle()">
                ...
                <div class="row d-flex" style="margin-top: 0px; margin-bottom: 50px">
                                    ...
                                    @foreach ($data as $key => $value)
                                        <label class="contactFilter">
                                            ...
                                            <span class="option-text"
                                                name="contact[]">{{ $value->contact ?? null }}</span>
                                        </label>
                                    @endforeach
                                </div>
                    ...
                    <div class="col-md-3">
                        <div class="dropdown" id="profile_linkDropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <input type="text" id="profile_linkSearchInput" placeholder="Search..."
                                    oninput="filterprofile_link()">
                                <div class="dropdown-options" id="profile_linkOptions">
                                    ...
                                    @foreach ($data as $key => $value)
                                        <label class="profile_linkFilter">
                                            <input type="checkbox" name="profile_link[]"
                                                value="{{ $value->profile_link ?? null }}">
                                            <span class="option-text"
                                                name="profile_link[]">{{ $value->profile_link ?? null }}</span>
                                        </label>
                                    @endforeach
                                </div>
