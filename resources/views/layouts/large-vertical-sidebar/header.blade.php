...
<div class="main-header">
    <div class="">
        <a href=""><img src="{{ asset('assets\images\faces\Untitled-1.png') }}" alt="" with="25px"></a>
    </div>
        ...
        <div class="dropdown">
            <div class="user col align-self-end">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                    ...
                    <a class="dropdown-item" href="{{ route('account-setting.edit', $user->id) }}">Account settings</a>
