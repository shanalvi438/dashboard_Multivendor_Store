        ...
        <div class="col-md-3" style="margin-left: 22px;">
            ...
            <form action="{{ route('advertisementSellers.details') }}" method="GET">
                <div class="row" style="margin-top: 5px;">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                ...
                                <div class="dropdown-options" id="idOptions">
                                    ...
                                    <label class="idFilter">
                                            <input type="checkbox" value="{{ $items->id }}" name="id[]">
                                            <span class="option-text" name="id[]">{{ $items->id }}</span>
                                        </label>
                                    @endforeach
                                </div>
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                ...
                                <div class="dropdown-options" id="nameOptions">
                                    ...
                                    <label class="nameFilter">
                                            <input type="checkbox" value="{{ $items->name }}" name="name[]">
                                            <span class="option-text" name="name[]">{{ $items->name }}</span>
                                        </label>
                                    @endforeach
                                </div>
                        ...
                        <div class="dropdown" id="nameDropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                ...
                                <div class="dropdown-options" id="nameOptions">
                                    ...
                                    @foreach ($data as $items)
                                    <label class="nameFilter">
                                            <input type="checkbox" value="{{ $items->advertisement->name }}" name="name[]">
                                            <span class="option-text" name="name[]">{{ $items->advertisement->name }}</span>
                                        </label>
                                    @endforeach
                                </div>
                                <div id="selectednameList"></div>
                    ...
                    <div class="col-md-2">
                        <div class="dropdown" id="daysDropdown">
                            <div class="dropdown-toggle" id="dropdownMenuButton2" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <p class="text-left">Display Days</p>
                            </div>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                <input type="text" id="daysSearchInput" placeholder="Search..."
                                    oninput="filterdays()">
                                <div class="dropdown-options" id="daysOptions">
                                    <label class="daysFilter" for="daysFilter">
                                        <input type="checkbox" id="selectAlldays" class="daysFilter">
                                        <span class="option-text" name="days[]">Select All</span>
                                    </label>
                                    <div id="selecteddaysOptions"></div>
                                    @foreach ($data as $items)
                                    <label class="daysFilter">
                                            <input type="checkbox" value="{{ $items->advertisement->days }}" name="days[]">
                                            <span class="option-text" name="days[]">{{ $items->advertisement->days }}</span>
                                        </label>
                                    @endforeach
                                </div>
                        ...
                        <div class="dropdown" id="nameDropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                ...
                                <div class="dropdown-options" id="nameOptions">
                                    ...
                                    <label class="nameFilter">
                                            <input type="checkbox" value="{{ $item->name }}" name="name[]">
                                            <span class="option-text" name="name[]">{{ $item->name }}</span>
                                        </label>
                                    @endforeach
                                </div>
                                <div id="selectednameList"></div>
                    ...
                    <div class="col-md-2">
                        <div class="dropdown" id="phoneDropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                <input type="text" id="phoneSearchInput" placeholder="Search..."
                                    oninput="filterphone()">
                                <div class="dropdown-options" id="phoneOptions">
                                    <label class="phoneFilter" for="phoneFilter">
                                        <input type="checkbox" id="selectAllphone" class="phoneFilter">
                                        <span class="option-text" name="phone[]">Select All</span>
                                    </label>
                                    <div id="selectedphoneOptions"></div>
                                    @foreach ($data as $key => $item)
                                    <label class="phoneFilter">
                                            <input type="checkbox" value="{{ $item->phone }}" name="phone[]">
                                            <span class="option-text" name="phone[]">{{ $item->phone }}</span>
                                        </label>
                                    @endforeach
                                </div>
                                <div id="selectedphoneList"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->name ?? 'deleted from database' }}</td>
                    ...
                    @if ($item->id ?? null)
                        <form id="editForm" action="{{ route('advertisementOrderImageUpdate', ['id' => $item->id]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="days" id="display_days" value=""
                                    class="form-control">
                            </div>
