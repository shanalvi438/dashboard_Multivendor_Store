...
@section('main-content')
    ...
    <div class="card-body">
        <div class="filter-card" id="filterCard">
            ...
            {{-- <form action="{{ route('get_order_details', ['id' => $orderDetail->id]) }}" method="GET"> --}}
                {{-- <form action="{{ url('get_order_details/' . $orders->id) }}" method="GET"> --}}
                    ...
                    <div class="col-md-2">
                        <div class="dropdown" id="vendorDropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton6">
                                <input type="text" id="vendorSearchInput" placeholder="Search..."
                                    oninput="filtervendor()">
                                <div class="dropdown-options" id="vendorOptions">
                                    <label class="vendorFilter" for="vendorFilter">
                                        <input type="checkbox" id="selectAllvendor" class="vendorFilter">
                                        <span class="option-text" name="vendor[]">Select All</span>
                                    </label>
                                    <div id="selectedvendorOptions"></div>
                                    @foreach ($GetOrderDetails as $value => $orders)
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="deafult_ordering_table" class="display table table-striped table-bordered"
                        ...
                        <tbody>
                            @foreach ($GetOrderDetails as $orders)
                                <tr>
                                    ...
                                    <td>{{ $orders->product->model_no }}</td>
                                    <td>{{ $orders->product->sku }}</td>
