...
class PortfolioController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $s = $request->file('image')->store('public/images');
    
        // Update $bdata with the image paths
        $s->image = str_replace('public/', 'storage/', $s);
        // Generate a unique filename for the image
        // $imageName = time().'.'.$s->getClientOriginalExtension();

        // Store the image in the storage folder
        // $s->storeAs('public/images', $imageName);
